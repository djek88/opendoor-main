define(['./app'], function(opendoorApp) {
  opendoorApp.config(function($locationProvider, $routeProvider) {
    ...
    $routeProvider
      ...
      .when('/events/search', {
        ...
        // meta: `Find your ideal job anywhere in the World.
        // Jobs listed associated with running a Place of Worship`,
