define(['angular', 'app'], function (angular, opendoorApp) {
  opendoorApp.registerController('PlaceViewCtrl', ['$scope', '$rootScope', '$location', '$http', '$cookies', '$anchorScroll', '$sce', PlaceViewCtrl]);
  opendoorApp.registerController('PlaceContactFormCtrl', [function () {}]);

  function PlaceViewCtrl($scope, $rootScope, $location, $http, $cookies, $anchorScroll, $sce) {
    ...
    function setData($place) {
      ...
      if ($place.mainMeetingTime || $place.mainMeetingDay) {
        ...
        if ($place.mainMeetingTime) {
          $scope.mainMeetingText += $place.mainMeetingTime + ' ';
        }
