define(['angular', 'app'], function(angular, opendoorApp) {
  ...
  opendoorApp.registerController('ErrorCtrl', [
    '$scope',
    '$location',
    function($scope, $location) {
      ...
      switch (message) {
        ...
        case 'alreadyregistered':
          ...
          $scope.alertTitle = 'Error';
          $scope.alertMessage =
            'Your email already exists in our database. Please try to restore your password';
          break;
        case 'notfound':
          $scope.alertType = 'danger';
          $scope.alertTitle = 'Error';
        ...
        case 'feedbacksaved':
          ...
          $scope.alertMessage =
            'Thank you for taking the time to send us feedback. We will reply to you as soon as we can and normally within 24 hours.';
          break;
        ...
        case 'claimadded':
          ...
          break;
        case 'claimealreadyexists':
          $scope.alertType = 'danger';
          $scope.alertTitle = 'Error';
          $scope.alertMessage =
            'Claim already exists. Please wait until administrator accept your claim.';
          break;
        case 'claimaccepted':
          $scope.alertType = 'info';
          $scope.alertTitle = 'Success';
        ...
        case 'claimnotfound':
          $scope.alertType = 'danger';
          $scope.alertTitle = 'Error';
          $scope.alertMessage = 'Claim has not found.';
          break;
        case 'reviewsaved':
          $scope.alertType = 'info';
